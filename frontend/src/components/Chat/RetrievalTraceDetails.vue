    ...
    <details class="reasoning-details">
      ...
      <div class="reasoning-content">
        ...
        <div v-if="hasRetrievalFunnel(msg.ragTrace)" class="trace-line trace-funnel">
          检索漏斗：Milvus 召回 {{ msg.ragTrace.recall_count ?? '—' }} → 合并后
          {{ msg.ragTrace.post_merge_candidate_count ?? '—' }} → 精排输入 {{ msg.ragTrace.candidate_count ?? '—' }} →
        ...
        <div
          v-if="msg.ragTrace.auto_merge_enabled !== null && msg.ragTrace.auto_merge_enabled !== undefined"
          class="trace-line"
        >
          Auto-merging启用：{{ msg.ragTrace.auto_merge_enabled ? '是' : '否' }}
        </div>
        <div
          v-if="msg.ragTrace.auto_merge_applied !== null && msg.ragTrace.auto_merge_applied !== undefined"
          class="trace-line"
        >
        ...
        <div v-if="msg.ragTrace.auto_merge_steps" class="trace-line">合并轮次：{{ msg.ragTrace.auto_merge_steps }}</div>
        <div
        ...
        <div v-if="msg.ragTrace.rerank_model" class="trace-line">Rerank模型：{{ msg.ragTrace.rerank_model }}</div>
        <div v-if="msg.ragTrace.rerank_error" class="trace-line">Rerank状态：{{ msg.ragTrace.rerank_error }}</div>
        ...
        <div v-if="msg.ragTrace.hyde_document" class="trace-line">HyDE 假设文档：{{ msg.ragTrace.hyde_document }}</div>
        ...
        <div
          v-if="msg.ragTrace.initial_retrieved_chunks && msg.ragTrace.initial_retrieved_chunks.length"
          class="sources"
        >
        ...
        <div
          v-if="msg.ragTrace.rewrite_retrieved_chunks && msg.ragTrace.rewrite_retrieved_chunks.length"
          class="sources"
        >
